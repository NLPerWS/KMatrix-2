...
def main(args, model=None) -> SummarizationModule:
    ...
    if catch_trainer == None:
        ...
        RootConfig.tempModelCatch.append({"path":args.model_name_or_path+"_model","data":model})
        RootConfig.tempModelCatch.append({"path":args.model_name_or_path+"_traner","data":trainer})
    else:
        model = catch_model
        trainer = catch_trainer
