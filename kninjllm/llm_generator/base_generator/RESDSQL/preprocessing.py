...
def parse_option():
    ...
    parser.add_argument('--natsql_dataset_path', type = str, default = "./NatSQL/NatSQLv1_6/train_spider-natsql.json", 
                        help = '''
                            ...
                            ''')
    parser.add_argument('--output_dataset_path', type = str, default = "./data/preprocessed_dataset.json", 
    ...
    if isinstance(opt.dbInfo,str):
        opt.dbInfo = json.loads(opt.dbInfo)

    return opt

def get_db_contents(question, table_name_original, column_names_original, db_id, db_path,root_path,dbInfo):
    matched_contents = []
