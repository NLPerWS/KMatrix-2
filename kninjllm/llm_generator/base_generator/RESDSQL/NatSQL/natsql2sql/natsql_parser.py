...
def create_sql_from_natSQL(nsql, db_name, db, table_json, sq=None, remove_values=False, remove_groupby_from_natsql=False, args = Args(),root_path="",dbInfo={}):
    find_table = table_json
    
    # Schema MODEL:
    schema = Schema_Star(get_schema(db, find_table,root_path=root_path,dbInfo=dbInfo))
