...
class DBEngine:
    DB_SHARE = None
    def __init__(self, schema, database_path,root_path="",dbInfo = {}):
        ...
        try:
            ...
            self.db = MySQLUtils(host=dbInfo['host'], user=dbInfo['user'], password=dbInfo['password'], database=dbInfo['database']).connection
