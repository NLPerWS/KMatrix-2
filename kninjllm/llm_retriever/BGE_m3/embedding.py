...
from kninjllm.llm_retriever.BGE_m3.model_eval import get_model
...
class Args:
    ...
    encoded_embedding_pth: str = field(
        default=RootConfig.root_path + "kninjllm/llm_retriever/BGE_m3/FaissSave/Bert-base/fiqa_content.memmap",
    ...
    results_dir: str = field(
        default=RootConfig.root_path + "kninjllm/llm_retriever/BGE_m3/TestResult/Bert-base",
        metadata={'help': 'relation between corpus and query.'}
    )
