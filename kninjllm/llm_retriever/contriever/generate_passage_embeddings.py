    ...
    with torch.no_grad():
        for k, p in enumerate(passages):
            ...
            if args.normalize_text:
                text = kninjllm.llm_retriever.contriever.src.normalize_text.normalize(text)
...
def main_do_embedding(passages,model_name_or_path=RootConfig.contriever_model_path,no_fp16=False,shard_id=0,num_shards=1):
    ...
    model, tokenizer, _ = kninjllm.llm_retriever.contriever.src.contriever.load_retriever(model_name_or_path)
