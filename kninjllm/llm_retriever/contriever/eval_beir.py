...
import kninjllm.llm_retriever.contriever.src.beir_utils
import kninjllm.llm_retriever.contriever.src.utils
import kninjllm.llm_retriever.contriever.src.dist_utils
import kninjllm.llm_retriever.contriever.src.contriever
...
def main(args):
    ...
    kninjllm.llm_retriever.contriever.src.slurm.init_signal_handler()

    os.makedirs(args.output_dir, exist_ok=True)

    logger = kninjllm.llm_retriever.contriever.src.utils.init_logger(args)
    ...
    metrics = kninjllm.llm_retriever.contriever.src.beir_utils.evaluate_model(
        ...
        is_main=kninjllm.llm_retriever.contriever.src.dist_utils.is_main(),
    ...
    if kninjllm.llm_retriever.contriever.src.dist_utils.is_main():
