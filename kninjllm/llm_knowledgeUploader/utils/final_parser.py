...
class Parser:
    ...
    def __init__(self,data_list,domain_mapping):
        self.data = data_list
    ...
    def get_retrieve_related_flag(self,generator,rationale,rationale_knowledge):
        ...
        cot_sc_responses = generator.run(prompt=query)['final_result'][0]['content']
    ...
    def get_cot_sc_results(self, data_point, generator, cot_prompt):
        ...
        cot_sc_responses = generator.run(prompt=cot_prompt)['final_result'][0]['content']
        ...
        self.log_str_list.append("Initial Reason Chain and Answer Generate: " + str(data_point["cot_response"]))
    ...
    def update_rationales_step_by_step(self, generator, data_point):
        ...
        rationale_1_knowl = retrieve_knowledge(domains, rationale_1, data_point,self.domain_mapping)
        ...
        self.log_str_list.append("Knowledge Query and Correction for First-Hop Reason:")
        self.log_str_list.append("Knowledge: " + str(rationale_1_knowl))
        ...
        if FLAG:
            ...
            edited_rationale_1 = generator.run(prompt = s2_edit_prompt_rationale_1)['final_result'][0]['content']
            ...
            new_rationale_2_source = generator.run(prompt=new_rationale_2_prompt)['final_result'][0]['content']
        ...
        self.log_str_list.append("First-Hop Reason Correction:" + str(edited_rationale_1))
        self.log_str_list.append("Second Reason Update:" + str(new_rationale_2))
        ...
        rationale_2_knowl = retrieve_knowledge(domains, new_rationale_2, data_point,self.domain_mapping)
        ...
        self.log_str_list.append("Knowledge Query and Correction for Seconde-Hop Reason: " )
        self.log_str_list.append("Knowledge: " + str(rationale_2_knowl))
        ...
        if FLAG_2:
            ...
            edited_rationale_2 = generator.run(prompt=s2_edit_prompt_rationale_2)['final_result'][0]['content']
        ...
        self.log_str_list.append("Second-Hop Reason Correction:" + str(edited_rationale_2))
    ...
    def update_rationales_at_once(self,generator, data_point):
        ...
        edited_rationale_1 = generator.run(prompt=s2_edit_prompt_rationale_1)['final_result'][0]['content'].strip()
        ...
        # retreive knowledge for rationale 2
        rationale_2_knowl = retrieve_knowledge(domains, rationale_2, data_point,self.domain_mapping)
        ...
        edited_rationale_2 = generator.run(prompt=s2_edit_prompt_rationale_2)['final_result'][0]['content'].strip()
    ...
    def get_final_answer(self, generator, data_point):
        ...
        if data_point["edited_rationale_1"]==data_point["cot_sc_rationales"][0]  and data_point["edited_rationale_2"]==data_point["cot_sc_rationales"][1]:
            ...
            final_answer = generator.run(prompt=s3_answer_consolidation_prompt)['final_result'][0]['content']
            ...
            self.log_str_list.append("Final Answer Generate:" + str(show_final_answer))
