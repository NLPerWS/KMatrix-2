...
from kninjllm.llm_utils.file_parser.rag.settings import es_logger
from kninjllm.llm_utils.file_parser.rag.utils import rmSpace
from kninjllm.llm_utils.file_parser.rag.nlp import rag_tokenizer, query, is_english
import numpy as np
...
class Dealer:
    ...
    def sql_retrieval(self, sql, fetch_size=128, format="json"):
        from kninjllm.llm_utils.file_parser.api.settings import chat_logger
        sql = re.sub(r"[ `]+", " ", sql)
        sql = sql.replace("%", "")
